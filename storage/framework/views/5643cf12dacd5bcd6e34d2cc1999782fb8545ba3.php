                    ...
                    <div class="sidebar col-lg-2 collapse d-lg-block" id="navbarTogglerDemo03">
                        <?php if(Auth::user()): ?>
                            <?php if(Auth::user()->role_id == 1): ?>
                                ...
                                <a href="/users" <?php if(request()->route()->uri == 'users'||request()->route()->uri == 'registered-users' || request()->route()->uri == 'user-detail/{slug}' || request()->route()->uri == 'user-ban/{slug}' || request()->route()->uri == 'user-banned'): ?> class="active" <?php endif; ?>>Users</a>
                                <a href="/rent-logs" <?php if(request()->route()->uri == 'rent-logs'): ?> class="active" <?php endif; ?>>Rent Log</a>
                                <a href="/" <?php if(request()->route()->uri == '/'): ?> class="active" <?php endif; ?>>Book List</a>
...
<?php /**PATH D:\ProjectPribadi\renting\resources\views/layouts/mainlayout.blade.php ENDPATH**/ ?>